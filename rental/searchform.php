    ...
    <div class="wrapper">
        <div class="insert-form">
            ...
            <div class="input-fields">
                ...
                <input class="input" type="text" name="search" placeholder="e.g. Rental ID, Rental Date, Inventory ID, Customer ID, etc..." autofocus />
            </div>
