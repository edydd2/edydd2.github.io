...
<body>
    ...
    <div class="tabletitle">film_category</div>
    <table>
        <tr>
            <th>film_id</th>
            <th>category_id</th>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    echo '<tr>
                        ...
                        <td style=\'text-align: center;\'>
                            <a style=\'text-align: center;text-decoration: none;color: #9b0000;\' href=delete.php?filmid=' . $row["film_id"] . '&categoryid=' . $row["category_id"] . '>DELETE</a>' .
                        '</td>
