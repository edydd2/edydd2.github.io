    ...
    <div class="wrapper">
        <div class="insert-form">
            ...
            <div class="input-fields">
                ...
                <input class="input" type="number" name="inventoryid" placeholder="Select A Inventory ID To Update" autofocus required />
                
                <input class="input" type="number" name="newinventoryid" placeholder="Inventory ID" required />
                
                <input class="input" type="number" name="filmid" placeholder="Film ID" required />
...
if (ISSET($_POST['update'])) {
    ...
    $newinventoryid = $_POST['newinventoryid'];
    $filmid = $_POST['filmid'];
    $storeid = $_POST['storeid'];

    $sql = "UPDATE inventory SET inventory_id='$newinventoryid', film_id='$filmid', store_id='$storeid', last_update=now()
