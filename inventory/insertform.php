    ...
    <div class="wrapper">
        <div class="insert-form">
            ...
            <div class="input-fields">
                ...
                <input class="input" type="number" name="inventoryid" placeholder="Inventory ID" autofocus required />
                
                <input class="input" type="number" name="filmdid" placeholder="Film ID" required />
...
if (ISSET($_POST['insert'])) {
    ...
    $sql = "INSERT INTO inventory (inventory_id, film_id, store_id, last_update) 
            VALUES ('$inventoryid', '$filmid', '$storeid', now());";
