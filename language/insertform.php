    ...
    <div class="wrapper">
        <div class="insert-form">
            ...
            <div class="input-fields">
                ...
                <input class="input" type="number" name="languageid" placeholder="Language ID" autofocus required />
...
if (ISSET($_POST['insert'])) {
    ...
    if (1 == preg_match('/[0-9]/', $language)) {
        ...
        $sql = "INSERT INTO language (language_id, language, last_update) 
                VALUES ('$languageid', '$language', now());";
