    ...
    <div class="wrapper">
        <div class="insert-form">
            ...
            <div class="input-fields">
                ...
                <input class="input" type="number" name="storeid" placeholder="Select A Store ID To Update" autofocus required />
                
                <input class="input" type="number" name="newstoreid" placeholder="Store ID" required />
                
                <input class="input" type="number" name="managerstaffid" placeholder="Manager Staff ID" required />
...
if (ISSET($_POST['update'])) {
    ...
    $newstoreid = $_POST['newstoreid'];
    $managerstaffid = $_POST['managerstaffid'];
    $addressid = $_POST['addressid'];

    $sql = "UPDATE store SET store_id='$newstoreid', manager_staff_id='$managerstaffid', address_id='$addressid', last_update=now()
