    ...
    <div class="wrapper" style="margin-top: 2%">
        <div class="insert-form">
            ...
            <div class="input-fields">
                ...
                <input class="input" type="number" name="addressid" placeholder="Address ID" autofocus required />
...
if (ISSET($_POST['insert'])) {
    ...
    $sql = "INSERT INTO address (address_id, address, address2, district, city_id, postal_code, phone, last_update) 
            VALUES ('$addressid', '$address', '$address2', '$district', '$cityid', '$postalcode', '$phone', now());";
